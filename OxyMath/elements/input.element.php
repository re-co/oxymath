...
class ExampleElement extends OxyEl {
    ...
    function render($options, $defaults, $content) {
        ...
        if($options['input_types'] === 'number'){
            ?>
            <input class="matform-element matform-track-is-<?php echo $track_visible; ?>" data-mathref="<?php echo $ref; ?>" id="<?php echo $label; ?>" name="<?php echo $label; ?>" type="number" step="2" value="<?php echo $val; ?>" min="<?php echo $min; ?>" max="<?php echo $max; ?>" onchange="codaMathForm()">
        <?php
        }
        else if($options['input_types'] === 'range'){
            ?>
            <input class="matform-element <?php echo $advanced_style; ?>" data-mathref="<?php echo $ref; ?>"  type="range" step="2" value="<?php echo $val; ?>" min="<?php echo $min; ?>" max="<?php echo $max; ?>" id="<?php echo $label; ?>" name="<?php echo $label; ?>" onchange="codaMathForm()">
            <?php
            }
